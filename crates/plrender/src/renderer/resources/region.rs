...
impl TextureRegion {
    ...
    pub fn union(&mut self, other: TextureRegion) {
    ...
    pub fn intersects(&self, other: TextureRegion) -> bool {
    ...
    /// Clamps this TextureRegion to a theoretical overlap of another TextureRegion,
    /// referring to "overlapping pixels" (such as a copy destination vs copy source),
    /// in such a way that only pixels that are valid for both TextureRegions are valid.
    ///
    /// The other TextureRegion is also clamped to reflect the same overlap.
    ///
...
mod tests {
    ...
    fn clamp_with_intersection() {
        fn test(
            ...
            b_point: (i32, i32),
            size: (i32, i32),
            expected_a: TextureRegion,
            expected_b: TextureRegion,
        ) {
        ...
        test(
            TextureRegion::for_whole_size(10, 10),
            TextureRegion::for_whole_size(10, 10),
            (0, 0),
            (0, 0),
            (5, 5),
            TextureRegion::for_region_i32(0, 0, 5, 5),
            TextureRegion::for_region_i32(0, 0, 5, 5),
        );

        test(
            TextureRegion::for_whole_size(10, 10),
            TextureRegion::for_whole_size(150, 150),
            (-1, -1),
            (100, 100),
            (5, 5),
            TextureRegion::for_region_i32(0, 0, 4, 4),
            TextureRegion::for_region_i32(101, 101, 4, 4),
        );
        ...
        test(
            ...
            (100, 100),
            (15, 15),
            TextureRegion::for_region_i32(0, 0, 10, 10),
            TextureRegion::for_region_i32(101, 101, 10, 10),
        );

        test(
            TextureRegion::for_region(10, 10, 20, 20),
            TextureRegion::for_whole_size(150, 150),
            (15, 5),
            (0, 0),
            (15, 15),
            TextureRegion::for_region_i32(15, 10, 15, 10),
            TextureRegion::for_region_i32(0, 5, 15, 10),
        );

        test(
            TextureRegion::for_whole_size(800, 600),
            TextureRegion::for_whole_size(200, 40),
            (400, 440),
            (40, 0),
            (40, 40),
            TextureRegion::for_region_i32(400, 440, 40, 40),
            TextureRegion::for_region_i32(40, 0, 40, 40),
        );

        test(
            TextureRegion::for_whole_size(240, 180),
            TextureRegion::for_whole_size(238, 164),
            (-1, 0),
            (0, 0),
            (240, 180),
            TextureRegion::for_region_i32(0, 0, 237, 164),
            TextureRegion::for_region_i32(1, 0, 237, 164),
        );
        ...
        test(
            ...
            (0, 15),
            (100, 100),
            TextureRegion::for_region_i32(0, 0, 0, 0),
            TextureRegion::for_region_i32(0, 0, 0, 0),
        );
    }
}
