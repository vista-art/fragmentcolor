...
///
/// ```
/// use fragmentcolor::{FragmentColor, AppOptions};
///
...
///
/// FragmentColor initializes main Event Loop when the user calls
/// `FragmentColor::run()`. This function never returns, it will
