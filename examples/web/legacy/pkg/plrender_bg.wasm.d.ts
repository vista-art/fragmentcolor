...
export function __wbg_fragmentcolor_free(a: number): void;
...
export function fragmentcolor_new(): number;
export function fragmentcolor_config(a: number, b: number): void;
export function fragmentcolor_run(a: number): void;
export function fragmentcolor_trigger(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function fragmentcolor_resolution(a: number): number;
