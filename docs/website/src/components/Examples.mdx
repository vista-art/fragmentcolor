...
<Code code="cargo add fragmentcolor" lang="bash" />
...
<Code code="swift package add https://github.com/vista-art/fragmentcolor" lang="bash" />
...
<Code code={`# app/build.gradle
implementation("org.fragmentcolor:fragmentcolor:0.11.0")`} lang="bash" />
