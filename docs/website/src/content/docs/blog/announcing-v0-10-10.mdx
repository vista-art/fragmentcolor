---
title: "FragmentColor 0.10.10: long-lived WASM sessions"
...
v0.10.10 improves stability of the WASM bindings during long-running browser sessions. When the `ArrayBuffer` detaches mid-session, the binding switches to a live view of `wasm.memory.buffer` and continues operating.
