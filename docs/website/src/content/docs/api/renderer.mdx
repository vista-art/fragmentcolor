---
title: Renderer
description: "The [Renderer](https://fragmentcolor.org/api/renderer) is the main entry point for [FragmentColor](https://fragmentcolor.org) and normally the first object you create."
---
...
```rust path=null start=null collapse={2-2, 4-4, 14-16}
