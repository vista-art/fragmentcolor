...
const v = Vertex.fromPosition(Position.Pos3([0.0, 0.0, 0.0])).withUv([0.5, 0.5]);
`}
lang="js"
/>
...
v = Vertex.from_position(Position.Pos3([0.0, 0.0, 0.0])).with_uv([0.5, 0.5])
`}
lang="python"
/>
...
code={`
import { {Vertex, Position} } from "fragmentcolor";
const v = Vertex.fromPosition(Position.Pos3([0.0, 0.0, 0.0])).withUv([0.0, 1.0]);
`}
lang="js"
/>
...
code={`
from fragmentcolor import {Vertex, Position}
v = Vertex.from_position(Position.Pos3([0.0, 0.0, 0.0])).with_uv([0.0, 1.0])
`}
lang="python"
/>
...
code={`
import { {Vertex, Position} } from "fragmentcolor";
const v = Vertex.fromPosition(Position.Pos3([0.0, 0.0, 0.0])).withColor([1.0, 0.0, 0.0, 1.0]);
`}
lang="js"
/>
...
code={`
from fragmentcolor import {Vertex, Position}
v = Vertex.from_position(Position.Pos3([0.0, 0.0, 0.0])).with_color([1.0, 0.0, 0.0, 1.0])
`}
lang="python"
/>
...
<Code
code={`
import { {Vertex, Position, VertexValue} } from "fragmentcolor";
const v = Vertex.fromPosition(Position.Pos3([0.0, 0.0, 0.0]));
    .withProperty("weight", VertexValue.F32(1.0));
`}
lang="js"
/>
