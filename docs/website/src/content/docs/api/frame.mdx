---
title: Frame
description: "The [Frame](https://fragmentcolor.org/docs/api/frame) object is a collection of [Pass](https://fragmentcolor.org/docs/api/pass) objects that are rendered to a [Target](https://fragmentcolor.org/docs/api/target) by the [Renderer](https://fragmentcolor.org/docs/api/renderer)."
---
