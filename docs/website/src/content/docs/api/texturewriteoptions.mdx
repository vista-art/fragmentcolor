...
let _opt = TextureWriteOptions.whole().withBytesPerRow(256).withRowsPerImage(64)
`}
lang="swift"
/>
...
val _opt = TextureWriteOptions.whole().withBytesPerRow(256).withRowsPerImage(64)
`}
lang="kotlin"
/>
...
code={`
import FragmentColor
let _opt = TextureWriteOptions.whole().withBytesPerRow(256)
`}
lang="swift"
/>
...
code={`
import org.fragmentcolor.*
val _opt = TextureWriteOptions.whole().withBytesPerRow(256)
`}
lang="kotlin"
/>
...
code={`
import FragmentColor
let _opt = TextureWriteOptions.whole().withRowsPerImage(64)
`}
lang="swift"
/>
