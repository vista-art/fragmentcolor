...
def run_all():
    ...
    files = [
        ...
        'core/pass/set_depth_target.py',
        'core/pass/set_target.py',
        ...
        'scene/light/directional.py',
        'scene/light/inner_cone_angle.py',
        'scene/light/intensity.py',
        'scene/light/kind.py',
        'scene/light/outer_cone_angle.py',
        'scene/light/point.py',
        'scene/light/position.py',
        'scene/light/range.py',
        'scene/light/set_color.py',
        'scene/light/set_cone_angles.py',
        'scene/light/set_direction.py',
        'scene/light/set_intensity.py',
        'scene/light/set_position.py',
        'scene/light/set_range.py',
        'scene/light/spot.py',
        ...
        'scene/material/double_sided.py',
        ...
        'scene/model/set_visible.py',
        'scene/model/transform.py',
        'scene/model/translate.py',
        'scene/model/visible.py',
        'scene/scene/add.py',
        'scene/scene/add_pass.py',
        'scene/scene/add_to.py',
        'scene/scene/ambient.py',
        'scene/scene/cameras.py',
        'scene/scene/find_pass.py',
        'scene/scene/get_pass.py',
        'scene/scene/lights.py',
        'scene/scene/list_passes.py',
        'scene/scene/load.py',
        'scene/scene/models.py',
        'scene/scene/new.py',
        'scene/scene/no_default_camera.py',
        'scene/scene/no_default_light.py',
        'scene/scene/no_defaults.py',
        'scene/scene/remove_pass.py',
        'scene/scene/set_default_camera.py',
        'scene/scene/set_default_light.py',
        'scene/scene/set_passes.py',
        ...
        'targets/texture_target/texture.py',
